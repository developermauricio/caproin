          ...
          <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-6">
              ...
              <p style="margin-top: -1rem;font-size: 0.9rem; display: none"
                 id="text-verify-identification-provider-edit" class="text-danger">El número de identificación ya
            ...
            <div class="col-12 col-md-6 col-lg-6">
              ...
              ></input-form>
              <p style="margin-top: -1rem;font-size: 0.9rem; display: none"
                 id="text-verify-code-provider-edit" class="text-danger">El código ya
                ha sido registrado</p>
            </div>
            <div class="col-12 col-md-6 col-lg-6">
              <input-form
    ...
    traerDatos(e) {
      ...
      setTimeout(() => {
        axios.get('/api/data-provider/' + this.idProvider).then(resp => {
          ...
          this.documentValidate = this.dataProvider.users.identification
          this.code = this.dataProvider.code
          this.codeValidate = this.dataProvider.code

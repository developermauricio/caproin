    ...
    identification: function (val) {
      ...
      if (val.length === 1) {
        setTimeout(() => {
          ...
          document.getElementById('text-verify-one-character-identification-provider').disabled = true;
        }, 200)
      } else {
        document.getElementById('text-verify-one-character-identification-provider').disabled = false;
        $("#txtIdentifacationProvider").removeClass("is-invalid");
        $("#text-verify-one-character-identification-provider").css("display", "none");
      }
    },
    code: function (val) {
      console.log(val)
      ...
      if (val.length === 1) {
        setTimeout(() => {
          ...
          document.getElementById('text-verify-one-character-code-provider').disabled = true;
        }, 200)
      } else {
        document.getElementById('text-verify-one-character-code-provider').disabled = false;
        $("#txtCodeProvider").removeClass("is-invalid");
        $("#text-verify-one-character-code-provider").css("display", "none");
      }
    },
    ...
    'provider.businessName'(val) {
      if (val.length === 1) {
        setTimeout(() => {
          ...
          document.getElementById('text-verify-one-character-provider').disabled = true;
        }, 200)
      } else {
        document.getElementById('text-verify-one-character-provider').disabled = false;
        $("#txtNameUserProvider").removeClass("is-invalid");
        $("#text-verify-one-character-provider").css("display", "none");
      }
    },
  },
  mounted() {

                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-4 col-lg-4">
                                            <input-form
                                                ...
                                                label="Nombres"
                                                pattern="alf"
                                                errorMsg="Ingrese nombres válidos"
                                                requiredMsg="El nombre del cliente es obligatorio"
                                                :modelo.sync="userName"
                                                :required="true"
                                                :msgServer.sync="errors.name"
                                            ></input-form>
                                            <p v-if="textValidaNameAddArchive">Estas agreando archivos para este cliente</p>
                                        </div>
                                        <div class="col-12 col-md-4 col-lg-4">
                                            <input-form
                                                id="txtUserLastName"
                                                ...
                                                requiredMsg="Los apellidos del cliente son obligatorios"
                                        ...
                                        <div class="col-12 col-md-4 col-lg-4">
                                            ...
                                            <p style="margin-top: -1rem;font-size: 0.9rem; display: none"
                                               id="text-verify-email" class="text-danger">El correo electrónico ya ha sido registrado</p>
                                        </div>
                                        <div class="col-12 col-md-4 col-lg-4">
                                            <input-form
                                                id="txtAddress"
                                                ...
                                                requiredMsg="La dirección es obligatoria"
                                ...
                                example: 'Ejemplo'
                                        ...
                                        <div class="col-12 col-md-4 col-lg-4">
                                            <input-form
                                                ...
                                                id="txtTypeCompany"
                                                errorMsg
                                                requiredMsg="La categoria del cliente es obligatoria"
                                                :required="true"
                                                :modelo.sync="user.typeCompany"
                                                :msgServer.sync="errors.typeCompany"
                                                type="multiselect"
                                                selectLabel="Buscar Categoría"
                                                :multiselect="{
                                        ...
                                        <div class="col-12 col-md-4 col-lg-4">
                                          ...
                                          'track-by':'id',
                                          label: 'name',
                                          'custom-label': positionType=>positionType.name
                                        }"
                                            ></input-form>
                                        </div>
                                        <div class="col-12 col-md-4 col-lg-4">
...
<!--                                    </div>-->
                                    ...
                                    <div class="row pt-2" v-if="addSocialNetworksNatural">
                                        ...
                                        <div class="col-12 col-lg-6 col-md-6 profiling">
                                            ...
                                            <input-form
                                                ...
                                                requiredMsg="Debes agregar al menos una red social"
                                                :required="true"
                                    ...
                                    <div class="row" v-if="objectSocialNetworks">
                                        ...
                                        >
                                            <input-form
                                                ...
                                                errorMsg="Ingrese una URL válida"
                                                requiredMsg="La URL es obligatoria"
                                                :required="true"
                                    ...
                                    <div class="row pt-1" v-if="addArchive">
                                        <div class="col-12">
                                            <label class="form-control-label" id="add-archive-dropzone-company-person">Agregar Archivos</label>
                            ...
                            >
                                <section style="width: 100%" v-if="currentTab===1">
                                    <h3 class="d-flex justify-content-center pb-2">Datos del Cliente</h3>
                                    <div class="row">
                                        <div class="col-12 col-md-4 col-lg-4">
                            ...
                            <template slot="footer" slot-scope="props">
                                ...
                                <div class="wizard-footer-right">
                                    ...
                                    <wizard-button v-else @click.native="createNewCustomer()"
                                                   ...
                                                   :style="props.fillButtonStyle">
                                        {{
                                            props.isLastStep ? 'Crear Cliente Persona Natural': 'Siguiente'
                                        }}
                                    </wizard-button>
                                </div>
                            </template>
...
export default {
    name: "CustomerTypePersonNatural",
    components: {
        Multiselect,
        VuePhoneNumberInput,
        vue2Dropzone
    ...
    methods: {
        ...
        createNewCustomer() {
            ...
            setTimeout(() => {
                ...
                if (document.querySelectorAll(".is-invalid").length > 0) {
                    this.$toast.error({
                        title: 'Error',
                        message: 'Revisar que todos los campos requeridos tengan datos',
                        showDuration: 1000,
                        hideDuration: 6000,
                        position: 'top right',
                    })
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        axios.post('/api/register/store-customer-person-natural', data).then(res => {
        ...
        btnAddArchivesCompany() {
            if (this.userName) {
                ...
                this.$toast.error({
                    title: 'Atención',
                    message: 'Para agregar archivos, debe ingresar el nombre del cliente',
                    showDuration: 1000,
                    hideDuration: 8000,
                })
            }
    ...
    watch: {
        ...
        //     if (!val.length) {TypePersonaNatural

<div class="navbar-container d-flex content">
    ...
    <ul class="nav navbar-nav align-items-center ml-auto">
        ...
        <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                                                       ...
                                                       aria-expanded="false">
                <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder pr-1">{{ auth()->user()->name }} {{ auth()->user()->last_name ? auth()->user()->last_name : '' }}</span><span
                        class="user-status pr-1">{{ auth()->user()->roles->first()->name }}</span></div>
                <span class="avatar">
...
{{--                         height="40" width="40">--}}
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                <a class="dropdown-item" data-toggle="modal" data-target="#default" href="#"><i class="mr-50" data-feather="user"></i> Perfil</a>

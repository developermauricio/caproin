...
(n=e.messageTop+h+h+n);e.messageBottom&&(n=n+h+h+e.messageBottom);c.customize&&(n=c.customize(n,c,b));c=f("<textarea readonly/>").val(n).appendTo(d);if(l.queryCommandSupported("copy")){d.appendTo(b.table().container());c[0].focus();c[0].select();try{var k=l.execCommand("copy");d.remove();if(k){b.buttons.info(b.i18n("buttons.copyTitle","Copiado en portapapeles"),b.i18n("buttons.copySuccess",{1:"Copió una fila al portapapeles",_:"Copiada %d filas en portapapeles"},a.rows),2E3);this.processing(!1);return}}catch(q){}}k=
